...
public class UserServiceBBDD {
    ...
    @GET
    @ApiOperation(value = "", notes = "hello")
    @ApiResponses(value = {
            @ApiResponse(code = 201, message = "Successful", response = UsuarioExamen.class),
            @ApiResponse(code = 501, message = "ERROR"),
            @ApiResponse(code = 506, message = "User Not found")
    })
    @Path("/{userId}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getusuarioexam(@PathParam("userId") String userId) {
        if (userId.isEmpty()){
            ...
            try{
                ...
                badges badge1 = new badges("Badge1", "http://localhost:8080/userphotos/mujer1.png");
                badges badge2 = new badges("Second Badge", "http://localhost:8080/userphotos/mujer1.png");
                badges badge3 = new badges("Third Badge", "http://localhost:8080/userphotos/mujer1.png");

                badgeList.add(badge1);
                badgeList.add(badge2);
                badgeList.add(badge3);

                Map<String, UsuarioExamen> userMap = new HashMap<>();

                UsuarioExamen user1 = new UsuarioExamen("Marcel", "http://localhost:8080/userphotos/mujer1.png", "Marcel","Guim",badgeList);
                UsuarioExamen user2 = new UsuarioExamen("Lluc", "http://localhost:8080/userphotos/mujer1.png", "Lluc","Falco", badgeList );
                UsuarioExamen user3 = new UsuarioExamen("Blau", "http://localhost:8080/userphotos/mujer1.png", "Blau", "Camarasa", badgeList);
                ...
                UsuarioExamen userFound = userMap.get(userId);

                if (userFound != null) {
                    logger.info("Usuario encontrado: " + userFound);
                    return Response.status(201).entity(userFound).build();
                } else {
                    logger.info("No se encontró el usuario con username '" + userId + "'.");
                    return Response.status(506).build();
                }
    ...
    @GET
    @ApiOperation(value = "Get all badges", notes = "hello")
    @ApiResponses(value = {
    ...
    public Response getbadges() {
        try{
            ...
            badges badge1 = new badges("Medalla Oro", "http://10.0.2.2:8080/userphotos/medalla_oro.png");
            badges badge2 = new badges("Medalla Plata", "http://10.0.2.2:8080/userphotos/medalla_oro.png");
            badges badge3 = new badges("Medalla Bronze", "http://10.0.2.2:8080/userphotos/medalla_oro.png");

            badgeList.add(badge1);
            badgeList.add(badge2);
            badgeList.add(badge3);

            GenericEntity<List<badges>> entity = new GenericEntity<List<badges>>(badgeList) {};
